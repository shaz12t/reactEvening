          ...
          <section className="pt-20 md:pt-40">
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                ...
                Welcome to CryptoCrawler!
                </h1>
                <p className="text-xl lg:text-2xl mt-6 font-light">
                Discover the world of cryptocurrencies with CryptoCrawler, your ultimate guide to navigating the crypto market. Whether you’re a seasoned trader or just starting out, our app provides you with the tools and insights you need to make informed decisions.
                </p>
                <p className="mt-8 md:mt-12 ">
                 <div className="gap-10">
                  ...
                  <button
                    type="button"
                    className=" py-4 px-12 bg-yellow-700 hover:bg-white-600 rounded text-white"
                  >
                    Sign In
                  </button>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  <div
                    ...
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)", overflowWrap: "break-word" }}
                  >
                    <p className="font-semibold text-xl text-yellow-700">Real-Time Market Data</p>
                    <p className="mt-4">
                    Stay updated with live prices, market trends, and the latest news.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  <div
                    className="p-12 rounded-lg border border-solid border-gray-200 mb-8"
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" , wordWrap: "break-word"}}
                  >
                    <p className="font-semibold text-xl text-yellow-700">Top Performers: </p>
                    <p className="mt-4">
                    Track the best-performing cryptocurrencies and see what’s trending.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  <div
                    ...
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)", overflowWrap: "break-word" }}
                  >
                    <p className="font-semibold text-xl text-yellow-700">Secure Transactions</p>
                    <p className="mt-4">
                    Buy, sell, and trade cryptocurrencies securely within the app.
                    </p>
                  </div>
                </div>
              </div>
